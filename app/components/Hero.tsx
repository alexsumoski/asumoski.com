...
const Hero: React.FC = () => {
  return (
    <div className="flex flex-col 2xl:flex-row xl:items-center justify-center h-[36rem] bg-black text-white">
      ...
      >
        <h1 className="2xl:text-10xl lg:text-9xl md:text-9xl sm:text-9xl text-white mb-4 md:mb-0">
          Alex
        </h1>
        <h1 className="2xl:text-10xl lg:text-9xl md:text-9xl sm:text-9xl font-bold text-white mb-4 md:mb-0">
          Sumoski
        </h1>
      </motion.div>
      <motion.div
